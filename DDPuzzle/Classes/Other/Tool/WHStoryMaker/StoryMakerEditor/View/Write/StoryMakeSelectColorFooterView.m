...
- (void)updateColorFooterViewInMainView
{
    if (self.type == StoryMakeSelectColorFooterViewTypeWriting) {
        ...
        self.contentTextView.frame = CGRectMake(0, 0, SCREENAPPLYSPACE(340), SCREENAPPLYHEIGHT(30));
        self.contentTextView.center = CGPointMake(self.centerX, SCREENAPPLYHEIGHT(180));
...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    if (size.height <= 200) {
        ...
        textView.center = CGPointMake(self.centerX, SCREENAPPLYHEIGHT(180));
    }else{
        CGRect frame = self.contentTextView.frame;
        frame.size.height = SCREENAPPLYHEIGHT(210);
        self.contentTextView.frame = frame;
