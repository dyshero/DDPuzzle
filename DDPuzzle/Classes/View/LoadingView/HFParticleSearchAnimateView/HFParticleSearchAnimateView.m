...
//#define kCircleRadius 36
#define kCircleTime 2.4
...
- (UIImage *)imgWithSize:(CGSize)size {
    UIImage *img = [UIImage imageWithColor:[[UIColor colorWithHexString:_color] colorWithAlphaComponent:0.72] withFrame:CGRectMake(0, 0, size.width, size.height)];
...
- (CAEmitterCell *)makeEmitterCellRate:(CGFloat)rate {
    ...
    cell.contents = (id)[[self imgWithSize:CGSizeMake(6*rate, 6*rate)] CGImage];
